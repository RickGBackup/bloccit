  ...
  context 'signed in user' do
    ...
    describe 'POST create' do
      ...
      it 'creates a favorite for the current user and specified post' do
        expect(my_user.favorites.find_by_post_id(my_post.id)).to be_nil  #a new user should have no favorites
        
        post :create, { post_id: my_post.id }
        
        expect(my_user.favorites.find_by_post_id(my_post.id)).not_to be_nil #the current user should have a favorite after favorite#create action
      end
    end
