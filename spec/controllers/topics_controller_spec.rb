...
RSpec.describe TopicsController, type: :controller do
  ...
  describe "GET index" do
    ...
    it "assigns my_topic to @topics" do
      get :index
      expect(assigns(:topics)).to eq([my_topic]) #expect the instance variable @topics to be equal to an array of one
    end
  end
  
  describe "GET show" do
    it "returns http success" do
      get :show, {id: my_topic.id}  #get :show requires an ID to be passed
      expect(response).to have_http_status(:success)
    end
    ...
    it "assigns my_topic to @topic" do
      get :show, {id: my_topic.id}  #get request passes the ID via the params hash to the controller.
  ...
  describe "GET edit" do
    ...
    it "assigns topic to be updated to @topic" do
      get :edit, {id: my_topic.id}
      topic_instance = assigns(:topic)  #the topic that has been requested
      
      #check its attributes equal those of the topic passed to the edit action
  ...
  describe "PUT update" do
    it "updates topic with expected attributes" do
      ...
      #call update on my_topic and provide new values for the attributes
      put :update, id: my_topic.id, topic: { name: new_name, description: new_description }
    
      updated_topic = assigns(:topic)
      #check that my_topic now has the updated attributes
