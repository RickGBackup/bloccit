...
RSpec.describe Label, type: :model do
  ...
  it { is_expected.to have_many :labelings }  #labelings are topics or posts
  ...
  describe "labelings" do
    it "allows the same label to be associated with a different topic and post" do
      ...
      topic_label = topic.labels[0]  #it should be the only label in the collection
  ...
  describe ".update_labels" do  #.update_labels, as it is a class method
