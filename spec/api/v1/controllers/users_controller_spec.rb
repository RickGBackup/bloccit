...
RSpec.describe Api::V1::UsersController, type: :controller do
  ...
  context "unauthenticated users" do
    ...
    it "PUT update returns http unauthenticated" do
      new_user = build(:user) # build is a FactoryGirl method - returns a User instance without saving to DB
  ...
  context "authenticated and unauthorized users" do
    #non-admin users are unauthorized to access User data via API
    before do
  ...
  context "authenticated and authorized users" do
    ...
    describe "GET index" do
      ...
      it "returns my_user serialized" do
        #expect an array of all the users, in Json format
    ...
    describe "GET show" do
      ...
      it "returns my_user serialized" do
        #expect that particular user, in json format
        expect(response.body).to eq(my_user.to_json)
      end
    end
    ...
    describe "PUT update" do
      context "with valid attributes" do
        # my_user is authenticated and authorized. 
        before do
          # update my_user with valid attribs
          @new_user = build(:user)
      ...
      context "with invalid attributes" do
        before do
          # attempt to update my_user with invalid attribs
    ...
    describe "POST create" do
      context "with valid attributes" do
       before do
         @new_user = build(:user)
          # send a request to create a new user using attribs of @new_user
