 ...
 # these methods check for an existing user, and an admin, respectively.
 # they will be used in callbacks in the API UsersController, TopicsController, etc, 
 # to restrict who is able to retrieve data.
